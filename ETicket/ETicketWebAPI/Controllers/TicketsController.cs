...
namespace ETicket.WebAPI.Controllers
{
    ...
    public class TicketsController : BaseAPIController
    {
        ...
        [SwaggerResponse(200, "Returns if everything was right. Contains a Ticket", typeof(TicketDto))]
        ...
        [SwaggerResponse(200, "Returns if everything was right. Contains a VerifyTicketResponse", typeof(VerifyTicketResponceDto))]
        [SwaggerResponse(400, "Returns if exception occurred")]
        [SwaggerResponse(401, "Returns if user was unauthorized")]
